...
get_header();  ?>
<!-- <div class="single-post-top-bunner" style="background-image: url(<?php echo get_field('main_image'); ?>);">
...
<div class="askan-post-content">
    <div class="askan-post-content-top">
        <div class="askan-post-content-right">
                <div class="site-logo">
                <img src="<?php echo $logo; ?>" >    
                </div>
                <div class="post-time">
                    <?php echo displayPostDateOrTime($postDate); ?>
                </div>
        </div>
        <div class="askan-post-content-left">
                ...
                <div class="option">
                    ...
                    <div class="open-report">
                        <div class="report-icon">
                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.73 3H8.27L3 8.27V15.73L8.27 21H15.73L21 15.73V8.27L15.73 3ZM19 14.9L14.9 19H9.1L5 14.9V9.1L9.1 5H14.9L19 9.1V14.9Z" fill="#575757"/><path d="M11 7H13V13H11V7ZM11 15H13V17H11V15Z" fill="#575757"/>
                            </svg>
                        </div>
                    </div>
    ...
    <div class="askan-post-content-center">
        <div class="askan-post-content-title">
            <h1><?php the_title(); ?></h1>
        </div>
        <div class="askan-post-content-subtitle">
            <?php the_excerpt(); ?>
        </div>

        <?php  if(get_field('main_image')) : ?>
            <div class="askan-post-main-image">
              <img src="<?php echo get_field('main_image'); ?>" >  
            </div>
        <?php endif; ?>

        <div class="askan-post-main-content">
                <?php the_content(); ?>
        </div>
        <div class="bottom-post">
                            <div class="tags">
                            ...
                            <div class="option">
                                <div class="report">דווח על תוכן לא הולם</div>
